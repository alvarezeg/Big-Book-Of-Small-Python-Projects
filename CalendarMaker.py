"""Calendar Maker, by Al Sweigart al@inventwitpython.com
...
def getCalendarFor(year, month):
  ...
  # (!) Try changing this to abbrevations: SUN, MON, TUE, etc.
  calText += '...Sunday.....Monday....Tuesday...Wednesday..Thursday....Friday....Sunday..\n'
  
  # The horizontal line string that separate weeeks:
  weekSeperator = ('+----------' * 7) + '+\n'
...
while open(calendarFilename, 'w') as fileObj:
